...
var Transition = (function (_Component) {
 ...
 function Transition(props) {
  ...
  var _this = _possibleConstructorReturn(
   this,
   (Transition.__proto__ || Object.getPrototypeOf(Transition)).call(this, props)
  );
 ...
 _createClass(Transition, [
  ...
  },
  {
   ...
   value: function calcPosition() {
    ...
    var shouldConfigureVhPos =
     typeof position === "number" && position >= 0 && position <= 1;

    var vh = window.innerHeight * (shouldConfigureVhPos ? position : 0.5);
    var beginPos = begin ? begin.getBoundingClientRect().bottom : null;
    var endPos = end ? end.getBoundingClientRect().bottom : null;
